...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupAddModal() {
        ...
        // FIX: updated route with admin prefix
    ...
    function setupEditModal(data) {
        ...
        // FIX: use the pre-generated action with admin prefix
    ...
    editBtns.forEach(btn => {
        btn.addEventListener('click', function() {
            const data = {
                action: this.dataset.action, // should be generated as admin.products.update
    ...
    productForm.addEventListener('submit', function(e) {
        ...
        saveBtn.innerHTML = `<span class="spinner"></span> Saving...`; // UX spinner
    });
});
