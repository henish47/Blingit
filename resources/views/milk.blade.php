...
<div class="bg-gray-50 font-sans">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div class="mb-6 md:mb-8 text-center">
            <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight">Dairy & Eggs</h1>
            <p class="mt-2 max-w-2xl mx-auto text-base sm:text-lg text-gray-600">
                Fresh milk, creamy yogurts, delicious cheeses, and farm-fresh eggs delivered to your door.
            </p>
        </div>
